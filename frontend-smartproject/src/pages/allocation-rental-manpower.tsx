    ...
    <div className="flex-1 min-w-0">
      <div className="cp-page-title-bar">
        <div className="flex min-w-0 items-center gap-3 text-[var(--text-primary)]">
          <UserRound className="cp-page-title-bar__icon h-6 w-6 shrink-0" />
          <div>
            <h1 className="cp-heading-lg">Rental manpower allocation</h1>
      ...
      <div className="cp-page-body">
        ...
        <Card className="border-[var(--border-subtle)] shadow-[var(--shadow-md)]">
          <CardHeader className="pb-3">
            <CardTitle className="cp-heading-md text-[var(--text-primary)]">Mapped to rental manpower resources</CardTitle>
