...
export default function ActivityMasterUom() {
  ...
  const createMutation = useMutation({
    ...
    onError: (e: Error) =>
      toast({ title: "Error creating UOM", description: e.message, variant: "destructive" }),
  });
  ...
  const updateMutation = useMutation({
    ...
    onError: (e: Error) =>
      toast({ title: "Error updating UOM", description: e.message, variant: "destructive" }),
  });
  ...
  const deleteMutation = useMutation({
    ...
    onError: (e: Error) =>
      toast({ title: "Error deleting UOM", description: e.message, variant: "destructive" }),
  });
    ...
    <div className="p-8 min-h-screen">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground mt-1">Manage units of measure for activities. Activities can only use UOMs from this list.</p>
          </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <Dialog open={isDialogOpen} onOpenChange={(o) => { setIsDialogOpen(o); if (!o) resetForm(); }}>
                ...
                <DialogContent className="max-w-md">
                  <DialogHeader>
                    <DialogTitle>{editingItem ? "Edit UOM" : "Add UOM"}</DialogTitle>
                  </DialogHeader>
          ...
          <div className="bg-white rounded-lg shadow overflow-hidden">
            {isLoading ? (
              ...
              <div className="p-8 text-center text-muted-foreground">No UOMs found. Add UOMs so activities can use them.</div>
            ) : (
              <Table>
                <TableHeader>
                  <TableRow>
                      ...
                      <TableCell>
                        <div className="flex gap-2">
                          ...
                          <Button
                            ...
                            onClick={() => confirm("Delete this UOM?") && deleteMutation.mutate(item.id)}
                          >
